...
class SetCriterion(nn.Module):
    ...
    def get_loss(self, loss, outputs, targets, indices, num_boxes, **kwargs):
        batch_len = kwargs.pop("batch_len", None)
    ...
    def forward(self, outputs, targets, **kwargs):
        ...
        batch_len = kwargs.get("batch_len")
        ...
        for loss in self.losses:
            loss_kwargs = {"batch_len": batch_len} if batch_len is not None else {}
            losses.update(self.get_loss(loss, outputs, targets, indices, num_boxes, **loss_kwargs))
