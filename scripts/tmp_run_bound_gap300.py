...
cmd=[sys.executable]+base+['--max-gap','300','--output-dir','outputs/oracle_link_bound_train/gap300/linked_results','--summary-json','outputs/oracle_link_bound_train/gap300/oracle_summary.json','--summary-csv','outputs/oracle_link_bound_train/gap300/oracle_summary.csv']
